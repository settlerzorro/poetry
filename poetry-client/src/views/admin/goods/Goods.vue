        ...
        <el-main>
          <div v-if="showList">
            ...
            >
              ...
              <el-table-column prop="goodsName" label="古诗词名称">
              </el-table-column>
          ...
          <div v-if="!showList">
            <el-form :model="goods" label-width="120px">
              ...
              <el-form-item label="作者">
                <el-input v-model="goods.author"></el-input>
              </el-form-item>
              <el-form-item label="朝代">
                <el-input v-model="goods.dynasty"></el-input>
              </el-form-item>
              ...
              <el-form-item label="解释">
                <el-input type="textarea" v-model="goods.explain"></el-input>
              </el-form-item>
              <el-form-item>
...
export default {
  ...
  methods: {
    ...
    queryCategory() {
      var that = this;
      this.$axios
        .get(that.domain + "/category/listAll", {
          headers: { token: localStorage.getItem("atoken") },
        })
        .then(function (res) {
          if (res.data.code == 0) {
    ...
    onSubmit(e) {
      ...
      this.$axios
        .post(that.domain + "/goods/" + action, data, {
          headers: { token: localStorage.getItem("atoken") },
        })
        .then(function (res) {
          console.log(res);
    ...
    del() {
      ...
      var that = this;
      this.$axios
        .post(that.domain + "/goods/delete", that.ids, {
          headers: { token: localStorage.getItem("atoken") },
        })
        .then(function (res) {
          console.log(res);
    ...
    upper() {
      ...
      var that = this;
      this.$axios
        .post(that.domain + "/goods/upper", that.ids, {
          headers: { token: localStorage.getItem("atoken") },
        })
        .then(function (res) {
          console.log(res);
    ...
    lower() {
      ...
      var that = this;
      this.$axios
        .post(that.domain + "/goods/lower", that.ids, {
          headers: { token: localStorage.getItem("atoken") },
        })
        .then(function (res) {
          console.log(res);
